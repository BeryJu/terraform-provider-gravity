...
type InstanceAPIInstanceInfo struct {
	...
	Dirs NullableExtconfigExtConfigDirs `json:"dirs"`
...
// If the value is explicit nil, the zero value for ExtconfigExtConfigDirs will be returned
func (o *InstanceAPIInstanceInfo) GetDirs() ExtconfigExtConfigDirs {
	if o == nil || o.Dirs.Get() == nil {
