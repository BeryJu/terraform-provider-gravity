...
type DhcpAPIScopesPutInput struct {
	...
	Dns NullableDhcpScopeDNS `json:"dns,omitempty"`
...
// SetDns gets a reference to the given NullableDhcpScopeDNS and assigns it to the Dns field.
func (o *DhcpAPIScopesPutInput) SetDns(v DhcpScopeDNS) {
	o.Dns.Set(&v)
}
// SetDnsNil sets the value for Dns to be an explicit nil
func (o *DhcpAPIScopesPutInput) SetDnsNil() {
	o.Dns.Set(nil)
}
